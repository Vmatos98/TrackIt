    ...
    return (
        <Container>
            ...
            <form onSubmit={send_data}>
                ...
                <input type="text" value={data.name} disabled = {disable? true:false} placeholder="nome" onChange={e => setData({...data ,name :e.target.value})}/>
                <input type="text" value={data.image} disabled = {disable? true:false} placeholder="foto" onChange={e => setData({...data ,image :e.target.value})}/>
